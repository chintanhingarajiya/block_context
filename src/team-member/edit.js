...
function Edit( {
	...
	if (context[ 'block-context/team-members-namecolor' ]) {
        setAttributes({ nameColor: context[ 'block-context/team-members-namecolor' ] });
    }
	if (context[ 'block-context/team-members-biocolor' ]) {
        setAttributes({ bioColor: context[ 'block-context/team-members-biocolor' ] });
    }
	...
	return (
		<>
			...
			<div { ...useBlockProps() }>
				{ url && (
					<div
						className={ `wp-block-block-context-team-member-img${
				...
				<div className="wp-block-block-context-team-member-social-links">
					<ul>
						...
						{ isSelected && (
							<li className="wp-block-block-context-team-member-add-icon-li">
								<Tooltip
									text={ __(
										'Add Social Link',
										'team-members'
				...
				{ selectedLink !== undefined && (
					<div className="wp-block-block-context-team-member-link-form">
						<TextControl
